...
class TgaDecoder {
    ...
    static TYPE_TRUE_COLOR = 2;
    static TYPE_GRAYSCALE = 3;
    static TYPE_RLE_TRUE_COLOR = 10;
    static TYPE_RLE_GRAYSCALE = 11;
    static TOP_ORIGIN_FLAG = 0x20;
    /**
     * Decodes a TGA file.
     *
     ...
     */
    static decodeRunLength(file, offset, byteCount, bytesPerPixel) {
     ...
     */
    static toRgba(pixels, width, height, bytesPerPixel, topOrigin) {
