...
const IsoBlockFilter_1 = __importDefault(require("./Lib/IsoBlockFilter"));
/**
...
class Main {
     ...
     */
    async run() {
        const filter = new IsoBlockFilter_1.default(process.cwd(), this.resolveProjectRoot(), this.parseSettings());
        await filter.run();
    }
    /**
