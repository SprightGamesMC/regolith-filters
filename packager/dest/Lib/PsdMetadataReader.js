...
class PsdMetadataReader {
    ...
    static read(sourcePath) {
        const fileHandle = fs_1.default.openSync(sourcePath, "r");
        try {
    ...
    static readBuffer(fileHandle, position, length) {
        ...
        const bytesRead = fs_1.default.readSync(fileHandle, buffer, 0, length, position);
        if (bytesRead < length) {
...
exports.default = PsdMetadataReader;
